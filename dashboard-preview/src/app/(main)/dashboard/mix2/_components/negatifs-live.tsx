...
export function NegatifsLive({ story, jour, loading }: { story: GammeStory | null; jour: string | null; loading?: boolean }) {
  const total = story ? story.resume.nouveaux + story.resume.persistants : null;
      ...
      <CardContent className="flex flex-col gap-4">
        {loading ? (
          ...
          <div className="flex h-64 items-center justify-center text-sm text-muted-foreground">
            Aucune donnée pour ce jour / rayon
          </div>
        ) : (
          <>
