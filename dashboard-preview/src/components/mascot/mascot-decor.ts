/**
 * Décor des états animés — portage de `src/bot/decor.ts` de bloub
 * (jeremy-prt/bloub, MIT) : anneaux 3D (orbites), balayage Lecture,
 * points Réflexion, particules Éclatement, rubans Comète, pastille.
 */

import { clamp, createRng, r2, TAU } from "./mascot-math";
...
/**
 * Projette un cercle 3D incliné en orthographique. La composante z coupe
 * l'arc en deux : moitié arrière dessinée avant le corps (occultée), moitié
 * avant après. C'est ce tri en profondeur qui fait lire des orbites.
 */
...
/** 6 anneaux, demi-grand axe 1.30-1.40, ~3.3 tours/s. */
...
/** Bouquet d'arcs qui balaie le triangle (Lecture), rmax 1.37. */
...
/** x mesurés des 3 points Réflexion : -0.557 / -0.013 / +0.532, y = 0. */
...
/** 5 particules Éclatement, une nouvelle toutes les 0.2 s, vie 0.55 s. */
...
/** Les particules spiralent vers le centre en grossissant, avalées derrière le noyau. */
...
/** Le point reste au centre, c'est la traînée qui l'orbite (4 rubans). */
...
/** Rayon du point de la comète. */
export const COMET_DOT = 0.129;

/** Bleu pastille relevé au pixel. */
export const NOTIF_BLUE = "#2496e8";
/** Pastille posée sur la circonférence, à -42deg. */
...
/** Encoche : disque concentrique soustrait du corps, marge 0.054 R. */
