...
const iconConfigs: Record<string, IconConfig> = {
	...
	gamme_image_article: {
		...
		bgColorLight: 'bg-fuchsia-500/20',
		iconColor: 'text-fuchsia-400',
	},
	gamme_history_query: {
		icon: Clock04Icon,
		bgColor: 'bg-slate-500/20 backdrop-blur',
		bgColorLight: 'bg-slate-500/20',
		iconColor: 'text-slate-400',
	},
	gamme_history_export: {
		icon: FileExportIcon,
	...
	gamme_imports: {
		...
		bgColorLight: 'bg-purple-500/20',
		iconColor: 'text-purple-400',
	},
	gamme_recherche_articles: {
		icon: Search02Icon,
	...
	gamme_structure_articles: {
		icon: Layers01Icon,
		bgColor: 'bg-stone-500/20 backdrop-blur',
		bgColorLight: 'bg-stone-500/20',
